...
class Company():
    ...
    def __init__(self, cik, name='', timeout=10):
        self.name = name
        self.cik = cik
    ...
    def get_data_files_from_10Q(self, document_type, no_of_documents=1, isxml=False) -> List[lxml.html.HtmlElement]:
    ...
    def get_data_files(self, document_type, filing_type, no_of_documents=1, isxml=False, ) -> List[lxml.html.HtmlElement]:
