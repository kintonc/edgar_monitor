...
class Stock:
    def __init__(self, symbol=None, cik=None):
        self.symbol = symbol

        if cik is None: # Kinton edited, 2020/11/21
            self.cik = self._find_cik() # Kinton edited, 2020/11/21
        else: # Kinton edited, 2020/11/21
            self.cik = cik # Kinton edited, 2020/11/21
    ...
    def get_filing(self, period='annual', year=0, quarter=0, filing_url = None): # Kinton added filing_url, 2020/11/21
        if filing_url is None: # Kinton added, 2020/11/21
